---
title: "Cómo crear un sistema de comentarios en Next.js con Firebase Realtime Database"
summary: "Lorem ipsum."
...
![Sistema de comentarios](/assets/images/nextjs-realtime-comments/project-result-1.png)

El código completo de este proyecto está disponible en [Git](https://github.com/alckordev/nextjs-realtime-comments/releases/tag/v1.0). Descarga este repositorio para empezar a trabajar.

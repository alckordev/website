...
El código completo de este proyecto está disponible en [Git](https://github.com/alckordev/comment-system/releases/tag/v1.0). Descarga este repositorio para empezar a trabajar.

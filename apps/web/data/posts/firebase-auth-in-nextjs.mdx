...
Si aún no estás familiarizado con él, te invito a leer el artículo anterior [**aquí**](http://localhost:3000/firebase-realtime-database-in-nextjs).
...
<CustomImage
  src="/assets/images/nextjs-realtime-comments/project-comment-1.png"
...
<CustomImage
  src="/assets/images/nextjs-realtime-comments/project-reply-1.png"

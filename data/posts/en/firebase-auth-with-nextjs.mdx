...
In this article, I’ll show you how to integrate Firebase Auth into a [Next.js](https://nextjs.org/docs/pages/getting-started) application
and perform certain tasks only when the user has an active session.

For this integration, we’ll build on our previous project “comment system.” If you’re not familiar with it, check out the previous

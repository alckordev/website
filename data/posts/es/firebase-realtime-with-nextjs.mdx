...
cover: "/images/data/firebase-realtime-with-nextjs.png"
...
En este artículo aprenderemos a integrar Firebase Realtime Database en una aplicación [Next.js](https://nextjs.org/docs/getting-started)
para construir un sistema de comentarios en tiempo real, que nos permita almacenar y visualizar los comentarios.
...
Para poder leer y escribir en nuestra base de datos debemos definir unas reglas desde la consola de [Firebase](https://console.firebase.google.com),
para este ejemplo, definiremos la arquitectura de la siguiente manera: cada comentario pertenecerá a un hilo,
y cada hilo será una representación de un post en nuestra aplicación,
asumiendo que los posts se obtiene desde otra fuente.
...
El código completo de este proyecto está disponible en [Github](https://github.com/alckordev/nextjs-firebase-chat).

¡Espero que te haya gustado y te haya sido útil!, Si tienes sugerencias o mejoras que hacer,
eres libre de realizar un "pull request" para contribuir.
